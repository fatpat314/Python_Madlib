...
print("                                                    ")
COMPASS_DIRECTION = input("Choose either North, South, East, or West: ") #0
print("                                                    ")
CITY = input("Enter a city: ") #1
print("                                                    ")
PLACE = input("Whats a place in that city?: ") #2
print("                                                    ")
VERB = input("Enter a verb: ") #3
print("                                                    ")
VERB2 = input("Enter a diffrent verb: ") #4
print("                                                    ")
PLACE2 = input("Whats a diffrent place in that city?: ") #5
print("                                                    ")
ACTIVITY = input("Enter your favorite activity: ") #6
print("                                                    ")
NOUN = input("Enter a singular noun: ") #7
print("                                                    ")
NOUN2 = input("Enter a type of competition: ") #8
print("                                                    ")
...
def function():
    ...
    print("and all {0}in' some {1} outside of the {2}".format(Veriable_ls[4], Veriable_ls[6], Veriable_ls[5]))
